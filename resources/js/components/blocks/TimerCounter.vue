...
<template>
  ...
  <div v-if="size === 'small'" class="mx-auto my-4 text-center">
    <div class="text-xs mb-2">{{ work.assigned_hour?.service.name }} - {{ work.assigned_hour?.client.name }}</div>
  ...
  <div v-else class="container mx-auto flex flex-col items-center gap-11 bg-white pt-6 pb-4 px-4">
    ...
    <div v-if="!isRecording" class="w-full">
      ...
      <div v-if="props.hasActiveWork" class="mt-2 text-sm leading-5 font-medium text-gray-600 text-center">
